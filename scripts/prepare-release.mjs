...
const commands=['lint','build','build:server','test:traffic','test:sse-budget','test:persistence-budget','test:game-routing','test:private-room-client','test:poker-chips','test:poker-motion','test:poker-pre-actions','test:poker-side-pots','test:poker-resilience','test:blackjack-rules','test:daily-vault','test:poker-cashout-referrals','test:ticket-accounting','test:pvp-handoff','test:multiplayer-rooms','test:casino-restart','test:production-auth','check:release'];
