      ...
      <div className="relative w-full max-w-lg max-h-[90vh] bg-[#0c0f12] text-[#f8fafc] pixel-box-lg flex flex-col overflow-hidden animate-pop">
        <div className="bg-[#00d2ff] p-4 text-black border-b-4 border-black flex justify-between items-center relative">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm min-[370px]:text-base font-black tracking-tight font-mono">{tr("rulesHeading")}</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 p-4 overflow-y-auto space-y-4 font-sans text-xs leading-relaxed text-slate-300">
          <div className="pixel-box-sm bg-blue-950/40 p-3 border-black text-left">
            <h3 className="font-black text-[#00d2ff] text-xs uppercase mb-1 font-mono">{tr("rulesGoal")}</h3>
            <p>
              <Trans ns="game" i18nKey="rulesGoalText" components={{ strong: <strong /> }} />
            </p>
          </div>

          <div className="space-y-2">
            <h3 className="font-black text-slate-100 text-xs uppercase font-mono">{tr("specialActions")}</h3>
            <div className="grid grid-cols-1 gap-2">
              <div className="flex gap-3 items-center pixel-box-sm bg-slate-950/50 p-2 border-black text-left">
                <div className="w-8 h-12 bg-black border border-black flex-shrink-0 overflow-hidden flex items-center justify-center shadow-[1px_1px_0_#000]">
                  <img src="/card-thumbs/Rug red.jpeg" alt={tr("skipCard")} className="w-full h-full object-cover select-none" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-200 text-xs flex items-center gap-1.5">
                    <span>{tr("skipTurn")}</span>
                    <span className="text-[7.5px] bg-[#ff4b4b] text-black px-1 border border-black font-black uppercase leading-tight">SKIP</span>
                  </h4>
                  <p className="text-slate-450 text-[9px] mt-0.5">{tr("skipDescription")}</p>
                </div>
              </div>

              <div className="flex gap-3 items-center pixel-box-sm bg-slate-950/50 p-2 border-black text-left">
                <div className="w-8 h-12 bg-black border border-black flex-shrink-0 overflow-hidden flex items-center justify-center shadow-[1px_1px_0_#000]">
                  <img src="/card-thumbs/Flip red.jpeg" alt={tr("reverseCard")} className="w-full h-full object-cover select-none" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-200 text-xs flex items-center gap-1.5">
                    <span>{tr("reverseDirection")}</span>
                    <span className="text-[7.5px] bg-[#00d2ff] text-black px-1 border border-black font-black uppercase leading-tight">REV</span>
                  </h4>
                  <p className="text-slate-450 text-[9px] mt-0.5">{tr("reverseDescription")}</p>
                </div>
              </div>

              <div className="flex gap-3 items-center pixel-box-sm bg-slate-950/50 p-2 border-black text-left">
                <div className="w-8 h-12 bg-black border border-black flex-shrink-0 overflow-hidden flex items-center justify-center shadow-[1px_1px_0_#000]">
                  <img src="/card-thumbs/plus2_red_v2.jpeg" alt={tr("drawTwoCard")} className="w-full h-full object-cover select-none" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-200 text-xs flex items-center gap-1.5">
                    <span>{tr("drawTwo")}</span>
                    <span className="text-[7.5px] bg-[#00ff66] text-black px-1 border border-black font-black uppercase leading-tight">+2</span>
                  </h4>
                  <p className="text-slate-450 text-[9px] mt-0.5">{tr("drawTwoDescription")}</p>
                </div>
              </div>

              <div className="flex gap-3 items-center pixel-box-sm bg-slate-950/50 p-2 border-black text-left">
                <div className="w-8 h-12 bg-black border border-black flex-shrink-0 overflow-hidden flex items-center justify-center shadow-[1px_1px_0_#000]">
                  <img src="/card-thumbs/wild 1.jpeg" alt={tr("wildCard")} className="w-full h-full object-cover select-none" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-200 text-xs flex items-center gap-1.5">
                    <span>{tr("wildSuit")}</span>
                    <span className="text-[7.5px] bg-[#ffcc00] text-black px-1 border border-black font-black uppercase leading-tight">WILD</span>
                  </h4>
                  <p className="text-slate-450 text-[9px] mt-0.5">{tr("wildDescription")}</p>
                </div>
              </div>

              <div className="flex gap-3 items-center pixel-box-sm bg-slate-950/50 p-2 border-black text-left">
                <div className="w-8 h-12 bg-black border border-black flex-shrink-0 overflow-hidden flex items-center justify-center shadow-[1px_1px_0_#000]">
                  <img src="/card-thumbs/plus4_red_v2.jpeg" alt={tr("drawFourCard")} className="w-full h-full object-cover select-none" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-200 text-xs flex items-center gap-1.5">
                    <span>{tr("drawFour")}</span>
                    <span className="text-[7.5px] bg-[#ec4899] text-black px-1 border border-black font-black uppercase leading-tight">+4</span>
                  </h4>
                  <p className="text-slate-450 text-[9px] mt-0.5">{tr("drawFourDescription")}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pixel-box-sm bg-slate-950/50 p-3 border-black text-left">
            <h3 className="font-black text-slate-100 text-xs uppercase mb-1 font-mono">{tr("finalCardCall")}</h3>
            <p className="mb-1">
              <Trans ns="game" i18nKey="finalCardText" components={{ strong: <strong /> }} />
            </p>
            <p>{tr("finalCardPenalty")}</p>
          </div>
          ...
          <div className="pixel-box-sm bg-slate-950 p-3 border-black text-left">
            <h3 className="font-black text-slate-300 text-[11px] mb-1 flex items-center gap-1.5 font-mono">
              <Award className="w-3.5 h-3.5 text-slate-400" />{tr("pointsSystem")}</h3>
            <p className="text-[10px] text-slate-400">{tr("scoringIntro")}<br />{tr("numbersPoints")}{' '}<strong>{tr("faceValue")}</strong>
              <br />{tr("actionsPoints")}{' '}<strong>{tr("twentyPoints")}</strong>
              <br />{tr("wildsPoints")}{' '}<strong>{tr("fiftyPoints")}</strong>
            </p>
          </div>

          <div className="pixel-box-sm bg-[#06131c] p-3 border-black text-left">
            <h3 className="font-black text-[#00ff66] text-xs uppercase mb-1 font-mono">{tr("matchModes")}</h3>
            <p className="text-[10px] text-slate-300">{tr("matchModesText")}</p>
          </div>
        </div>
